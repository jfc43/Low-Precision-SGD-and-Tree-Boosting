...
class GradientPairInternal {
  ...
  XGBOOST_DEVICE void SetGrad(int32_t g) { grad_ = g; }
  XGBOOST_DEVICE void SetHess(int32_t h) { hess_ = h; }
 ...
 public:
  ...
  XGBOOST_DEVICE GradientPairInternal(int32_t grad, int32_t hess) {
    SetGrad(grad);
    SetHess(hess);
  }
  ...
  XGBOOST_DEVICE int32_t GetGrad() const { return grad_; }
  XGBOOST_DEVICE int32_t GetHess() const { return hess_; }
  ...
  XGBOOST_DEVICE explicit GradientPairInternal(int value) {
    *this = GradientPairInternal<T>(value, value);
  }
...
template<>
inline XGBOOST_DEVICE int32_t GradientPairInternal<int32_t>::GetGrad() const {
  return grad_ * 1e-4f;
}
template<>
inline XGBOOST_DEVICE int32_t GradientPairInternal<int32_t>::GetHess() const {
  return hess_ * 1e-4f;
}
template<>
inline XGBOOST_DEVICE void GradientPairInternal<int32_t>::SetGrad(int32_t g) {
  grad_ = static_cast<int64_t>(std::round(g * 1e4));
}
template<>
inline XGBOOST_DEVICE void GradientPairInternal<int32_t>::SetHess(int32_t h) {
...
using GradientPair = detail::GradientPairInternal<int32_t>;
